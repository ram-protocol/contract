...
contract RErc20 {
     ...
     * @return uint 0=success, otherwise a failure (see "RToken Error Reporter" for details)
     */
    function seize(address liquidator, address borrower, uint seizeTokens) external returns (uint);

    /********   RErc20 User Interface   ********/
     ...
     * @return uint 0=success, otherwise a failure (see "RToken Error Reporter" for details)
     */
    function liquidateBorrow(address borrower, uint repayAmount, address rTokenCollateral) external returns (uint);
}
