...
/**
 * @title Ram's RTT Contract
 * @notice rToken which wraps ThunderToken (TT)
 */
contract RTT {
    /********    RToken Storages    ********/
     ...
     * @return uint 0=success, otherwise a failure (see TokenErrorReporter for details)
     */
